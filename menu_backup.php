                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="menu-item-card <?php echo $current_theme['card']; ?> rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <?php if (!empty($item_allergens)): ?>
                            <div class="mb-4">
                                <div class="text-xs font-bold text-slate-500 mb-2">
                                    <?php echo $lang == 'en' ? 'Allergens:' : 'Alerjenler:'; ?>
                                </div>
                                <div class="flex items-center gap-2 flex-wrap">
                                    <?php foreach ($item_allergens as $allergen): ?>
                                    <span class="inline-flex items-center gap-1.5 bg-orange-50 text-orange-700 px-2 py-1 rounded-lg text-xs font-bold border border-orange-200">
                                        <i class="fas <?php echo $allergen['icon']; ?>"></i>
